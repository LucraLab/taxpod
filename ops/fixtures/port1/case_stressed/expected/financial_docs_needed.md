...
- [ ] Pay stubs or income verification for: Freelance graphic design ($1200.00/mo)
- [ ] Pay stubs or income verification for: Part-time retail ($1800.00/mo)
- [ ] Profit & Loss (P&L) statement (current year)

## Dependents

- [ ] Childcare receipts or provider statements
- [ ] Proof of dependents (birth certificates, SSN cards)
...
- [ ] Auto loan statement (most recent)
- [ ] Vehicle registration or title

## Insurance / Medical

- [ ] Health insurance premium statement
- [ ] Summary of out-of-pocket medical expenses (if applicable)

## Debts

- [ ] Most recent statement for: Car loan - Honda Civic (balance: $14200.00)
- [ ] Most recent statement for: Federal student loan (balance: $32000.00)
- [ ] Most recent statement for: Mastercard (balance: $8500.00)

## Assets

- [ ] Bank statements for checking/savings (most recent 3 months)
- [ ] Property tax statement or recent appraisal
- [ ] Retirement account statement (most recent)
