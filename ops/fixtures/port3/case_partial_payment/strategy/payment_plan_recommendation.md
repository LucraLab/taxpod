...
- **Bundle path:** `fixtures/port3/case_partial_payment/bundle`
- **Model path:** `fixtures/port3/case_partial_payment/model/payment_plan_model.json`
- **Total liability:** $48500.00
- **Monthly capacity (likely):** $60.00
...
- **LOW_DISPOSABLE** — Very limited monthly capacity may affect agreement terms
...
- [ ] Discuss partial payment installment agreement eligibility
- [ ] Request Form 433-A requirements
...
- [ ] Complete Form 433-A with CPA assistance
- [ ] Contact IRS to request partial payment installment agreement
- [ ] Confirm no active liens or levies before proceeding

---
*Generated: 20260220T000000Z | Version: StrategyRecommendationV1 | Case: case_partial_payment*
